 ...
 * 
 */
package com.asatisamaj.matrimony.pagination;
...
public class DataTableRequest<T> {
	...
	private String searchByMemberId;

	private String searchByGender;

	private String searchBySamajArea;

	private String searchByAgeRange;

	private String searchByEducation;
	...
	public String getSearchByMemberId() {
		return searchByMemberId;
	}

	public void setSearchByMemberId(String searchByMemberId) {
		this.searchByMemberId = searchByMemberId;
	}

	public String getSearchByGender() {
		return searchByGender;
	}

	public void setSearchByGender(String searchByGender) {
		this.searchByGender = searchByGender;
	}

	public String getSearchBySamajArea() {
		return searchBySamajArea;
	}

	public void setSearchBySamajArea(String searchBySamajArea) {
		this.searchBySamajArea = searchBySamajArea;
	}

	public String getSearchByAgeRange() {
		return searchByAgeRange;
	}

	public void setSearchByAgeRange(String searchByAgeRange) {
		this.searchByAgeRange = searchByAgeRange;
	}

	public String getSearchByEducation() {
		return searchByEducation;
	}

	public void setSearchByEducation(String searchByEducation) {
		this.searchByEducation = searchByEducation;
	}

	public String getSearchByEducationDetails() {
		return searchByEducationDetails;
	}

	public void setSearchByEducationDetails(String searchByEducationDetails) {
		this.searchByEducationDetails = searchByEducationDetails;
	}

	public String getSearchByOccupation() {
		return searchByOccupation;
	}
